...
import 'package:mrbilit/components/customTextField.dart';

class beautyTf extends StatefulWidget {
  ...
  @override
  _beautyTf createState() => _beautyTf();
}

class _beautyTf extends State<beautyTf> {
  bool isFocus = false;
